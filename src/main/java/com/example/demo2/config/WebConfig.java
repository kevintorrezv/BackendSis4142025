    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                ...
                registry.addMapping("/**")
                        .allowedOrigins("http://localhost:4200", "http://localhost:8080", "https://*.ngrok-free.app",
                                        "https://kevintorrezv.github.io","https://exceptional-patrizia-systemstudio-46f70e92.koyeb.app/") // Permite cualquier origen (dominio)
